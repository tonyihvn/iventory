...
@section('content')
    <div class="container" style="width: 100% !important">
        ...
        <div class="card" style="padding: 20px !important;">
            ...
            <b>Category: {{ $item->category }} - <small><i>Stock Balance:
                        {{ $item->stock->quantity_remaining ?? '' }}</i></small></b>
        ...
        <table style="background-color: #ccc">
            <tr>
                <td>Total Received: <b>{{ $itemdist->where('sentto_state', 'Nasarawa')->sum('quantity_sent') }}</b></td>
                <td>Total Issued to Facilities:
