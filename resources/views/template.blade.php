...
<nav>
    <div class="nav-wrapper teal">
      ...
      <a href="{{url('/')}}" class="brand-logo"><img src="{{asset('/uploads/'.$site_settings->logo)}}" alt="{{$site_settings->organization_name}}" height="60" width="auto"></a>
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li>
                ...
                <ul id="profile-dropdown" class="dropdown-content">
                    <li><a href="{{url('/edit_user/'.Auth()->user()->id)}}"><i class="material-icons">person</i>Profile</a></li>
                    <li class="divider"></li>
      ...
      <li><a class="collapsible-header waves-effect waves-blue" href="{{url('/')}}"><i class="material-icons">dashboard</i>DASHBOARD</a></li>
          ...
          <ul class="collapsible collapsible-accordion">
                ...
                <li>
                  ...
                  <div class="collapsible-body">
                    <ul>
                      <li><a class="waves-effect waves-blue" href="{{url('/inventories')}}"><i class="material-icons">fullscreen</i>View All<span class="new badge right yellow grey lighten-1" data-badge-caption="updated"></span></a></li>
                      <li><a class="waves-effect waves-blue" href="{{url('/add_item')}}"><i class="material-icons">swap_horiz</i>Add New<span class="new badge right yellow darken-3"></span></a></li>
                      <li><a class="waves-effect waves-blue" href="{{url('/movements')}}"><i class="material-icons">transfer</i>Movements<span class="new badge right yellow darken-3"></span></a></li>
                      <li><a class="waves-effect waves-blue" href="{{url('/categories')}}"><i class="material-icons">swap_horiz</i>Categories<span class="new badge right yellow darken-3"></span></a></li>
                      <li><a class="waves-effect waves-blue" href="{{url('/damaged')}}"><i class="material-icons">fullscreen</i>Damaged<span class="new badge right yellow grey lighten-1" data-badge-caption="updated"></span></a></li>
                      <li><a class="waves-effect waves-blue" href="{{url('/lost')}}"><i class="material-icons">swap_horiz</i>Lost<span class="new badge right yellow darken-3"></span></a></li>
                      <li><a class="waves-effect waves-blue" href="{{url('/archived')}}"><i class="material-icons">swap_horiz</i>Archived<span class="new badge right yellow darken-3"></span></a></li>
                      <li><a class="waves-effect waves-blue" href="{{url('/requests')}}"><i class="material-icons">swap_horiz</i>Item Request</a></li>
      ...
      @elseif(auth()->user()->role=='Manager')
        ...
        <li><a class="waves-effect waves-blue" href="{{url('/add_item')}}"><i class="material-icons">swap_horiz</i>Add New<span class="new badge right yellow darken-3"></span></a></li>
        <li><a class="waves-effect waves-blue" href="{{url('/movements')}}"><i class="material-icons">transfer</i>Movements<span class="new badge right yellow darken-3"></span></a></li>
        <li><a class="waves-effect waves-blue" href="{{url('/facilities')}}"><i class="material-icons">swap_horiz</i>Facilities</a></li>
        <li><a class="waves-effect waves-blue" href="{{url('/departments')}}"><i class="material-icons">fullscreen</i>Departments</a></li>
        <li><a class="waves-effect waves-blue" href="{{url('/units')}}"><i class="material-icons">swap_horiz</i>Units</a></li>
      ...
      @if (auth()->user()->role=='Admin')
        <li class="white">
          <ul class="collapsible collapsible-accordion">
            <li>
              ...
              <div class="collapsible-body">
                <ul>
                  <li><a class="waves-effect waves-blue" href="{{url('/users')}}"><i class="material-icons">fullscreen</i>Users</a></li>
                  <li><a class="waves-effect waves-blue" href="{{url('/facilities')}}"><i class="material-icons">swap_horiz</i>Facilities</a></li>
                  <li><a class="waves-effect waves-blue" href="{{url('/departments')}}"><i class="material-icons">fullscreen</i>Departments</a></li>
                  <li><a class="waves-effect waves-blue" href="{{url('/units')}}"><i class="material-icons">swap_horiz</i>Units</a></li>
                  <li><a class="waves-effect waves-blue" href="{{url('/audits')}}"><i class="material-icons">swap_horiz</i>Audit Trail</a></li>
                </ul>
              </div>
            </li>
          </ul>
        ...
        <li class="white"><a class="waves-effect waves-blue" href="{{url('/reports')}}"><i class="material-icons">swap_horiz</i>Inventory Report</a></li>
        <li class="white"><a href="{{url('/edit_settings/1')}}"><i class="material-icons">settings</i>Settings</a></li>
        <li class="white"><div class="divider"></div></li>
      @endif
...
@endif
      ...
      <div class="row">
        ...
        <div class="col l2 s6">
          ...
          <ul>
            ...
            @if(Auth()->user()->role=="Admin")
                <li><a href="{{url('/edit_settings/1')}}" class="grey-text text-lighten-3">Settings</a></li>
            @endif
  ...
  <div id="lockscreenModal" class="modal bottom-sheet">
      <div class="modal-content center row">
        <img src="{{url('/uploads/'.$site_settings->logo)}}" alt="{{$site_settings->organization_name}}" height="60" width="auto">
        <hr>
