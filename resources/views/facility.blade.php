            ...
            <div class="card col s6 offset-s3" style="margin-top:20px;">
                ...
                <form method="POST" action="{{ route('facilities.update', $facility->id) }}">
                    ...
                    <div class="input-field">
                        <input id="facility_name" type="text" class="validate" name="facility_name"
                    ...
                    <div class="input-field">
                        <input id="facility_no" type="text" class="validate" name="facility_no"
                            value="{{ $facility->facility_no }}" required>
                    ...
                    <div class="input-field">
                        <input id="town" type="text" class="validate" name="town" value="{{ $facility->town }}"
                            required>
