    ...
    <div class="container">
        <div class="row">
            <div class="card col m8 offset-m2" style="margin-top:20px; padding: 35px;">
                <div>
                    <a href="{{ url('print_item/' . $item->id) }}"
                        class="btn btn-small btn-floating right green pulse tooltipped" data-position="top"
                        data-tooltip="Print this Item" target="_blank"><i class="material-icons">printer</i></a>
                </div>
                ...
                <form method="POST" action="{{ route('inventories.update', $item->id) }}">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="ihvn_no" type="text" class="validate" value="{{ $item->ihvn_no }}"
                                name="ihvn_no">
                            <label for="ihvn_no">IHVN Number</label>
                        </div>
                        <div class="input-field col s6">
                            <input id="tag_no" type="text" class="validate" value="{{ $item->tag_no }}"
                                name="tag_no">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s4">
                            <input name="type" id="type" list="type" type="text" value="{{ $item->type }}"
                                class="validate">
                            <datalist id="type">
                            ...
                            <tbody id="item_list">
                                @foreach ($item->inventoryspec as $key => $is)
                                    <tr scope='row' class='row{{ $key }}'>
                                        <td class='input-field'><input type='text' name='property[]'
                                                value='{{ $is->property }}' placeholder='e.g. Color, Brand etc'></td>
                                        <td class='input-field'>
                                        <td class='input-field'><input type='text' name='value[]'
                                                value='{{ $is->value }}' placeholder='e.g. Red, HP etc'></td>
                                        <td><a href='#' class='btn-floating red btn-small delpos'
