...
@section('content')
        ...
        <form action="product_search" class="row" style="width: 50%; margin: auto; text-align: center;" method="post">
            ...
            <div class="input-field col m2">
                <a href="{{url('/inventories')}}" class="btn btn-small btn-floating pulse green center tooltipped" data-position="top" data-tooltip="Print this page"  onclick='printtag("printable");'><i class="material-icons center">printer</i></a>
            </div>
        </form>
                    ...
                    <td>
                        <div class="fixed-action-btn horizontal direction-top direction-left click-to-toggle sales_action" style="position: relative !important; float: text-align: center; display: inline-block; bottom: 0px !important; padding: 0px !important">
                                ...
                                <ul style="top: 0px !important">
                                    ...
                                    <li>
                                            <a href="{{url('/item/'.$inv->id)}}" class="btn-floating btn-small waves-effect blue waves-light tooltipped" data-position="top" data-tooltip="View / Edit Item"><i class="material-icons">remove_red_eye</i></a>
                                    </li>

                                    <li>
                                            <a href="{{url('/move_item/'.$inv->id)}}" class="btn-floating btn-small waves-effect blue waves-light tooltipped" data-position="top" data-tooltip="Move / Transfer Item"><i class="material-icons">transfer</i></a>
                                    </li>
