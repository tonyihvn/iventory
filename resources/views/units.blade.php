...
@section('content')
    ...
    <div class = "row" style="width:98%; margin:auto;">
        ...
        @if ($units!=NULL)
          <div>
              <a href="add_unit" class="btn btn-small btn-floating right pulse"><i class="material-icons">add</i></a>
          </div>
                    ...
                    <td>                    
                        <div class="fixed-action-btn horizontal direction-top direction-left click-to-toggle sales_action" style="position: relative !important; float: text-align: center; display: inline-block; bottom: 0px !important; padding: 0px !important">
                                ...
                                <ul style="top: 0px !important">
                                    ...
                                    <li>
                                            <a href="unit/{{$un->id}}" class="btn-floating btn-small waves-effect blue waves-light tooltipped" data-position="top" data-tooltip="unit Inventory" target="_blank"><i class="material-icons">list</i></a>         
                                    </li>
